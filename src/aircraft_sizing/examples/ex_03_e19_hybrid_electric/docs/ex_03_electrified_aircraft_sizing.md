...
This is the electrified counterpart to the fuel-based [ASW example](../../ex_01_asw/docs/ex_01_asw_sizing.md). The contrast is the point: fuel burns off (weight drops through the mission), but **battery mass is constant**, which reshapes the range equation, the sizing loop, and the whole mass build-up.
